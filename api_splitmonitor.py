...
def fetch_splitmonitor_data(signal_ids, start_date, end_date):
                ...
                for phase in data:
                    ...
                    for plan in phase['plans']:
                        ...
                        record_plans.update({
                            ...
                            'start': plan['start'],
                            'end': plan['end'],
                            'percentSkips': plan['percentSkips'],
                            'percentGapOuts': plan['percentGapOuts'],
                            'percentMaxOuts': plan['percentMaxOuts'],
                            'percentForceOffs': plan['percentForceOffs'],
                            'averageSplit': plan['averageSplit'],
                            'programmedSplit': plan['programmedSplit'],
                            'percentileSplit85th': plan['percentileSplit85th'],
                            'percentileSplit50th': plan['percentileSplit50th']
                        })
...
df = fetch_splitmonitor_data(signal_ids=[7115], start_date='2024-11-06', end_date='2024-11-08')
print(df)
